...
# Consider the information available in the above two lists and answer the question given
#total no of orders
print("Total no. of orders",len(processed_orders) + len(returned_orders))

orders = processed_orders + returned_orders
orders.sort()
print("50th order",orders[49])
